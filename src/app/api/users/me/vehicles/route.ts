...
export async function GET(request: NextRequest) {
  try {
    ...
    const vehicles = vehiclesResult.map((v: any) => ({
      ...
      brandName: v.vehicleBrands?.name,
      brandNameEn: v.vehicleBrands?.name_en,
      brandLogoUrl: v.vehicleBrands?.logo_url,
  ...
  try {
    ...
    return NextResponse.json({ 
      ...
      vehicle: {
        ...
        brandName: newVehicle.vehicleBrands?.name,
        brandNameEn: newVehicle.vehicleBrands?.name_en,
        brandLogoUrl: newVehicle.vehicleBrands?.logo_url,
